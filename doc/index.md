...
own code - one DotBot, or a swarm of hundreds. Pick a starting point:
...
- **Before flashing hardware** - the simulator and driving an existing swarm
  need only Python; building and cable-flashing firmware also need SEGGER
  Embedded Studio and the nRF Command Line Tools (`nrfjprog`). See
