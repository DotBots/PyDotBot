...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            b"\x88\x77\x66\x55\x44\x33\x22\x11\x21\x12\x22\x12\x22\x12\x22\x12\x42\x14\x00\x09\x00\x00\x00\x00\x0d"
        ...
        pytest.param(
            b"\x88\x77\x66\x55\x44\x33\x22\x11\x21\x12\x22\x12\x22\x12\x22\x12\x42\x14\x00\x09\x00\x00\x00\x00\xfa"
            b"\x2d\x00"
            b"\x50\xc3\x00\x00"
            b"\xa8\x61\x00\x00",
            ProtocolPayload(
        ...
        pytest.param(
            b"\x11\x22\x22\x11\x11\x11\x11\x11\x12\x12\x12\x12\x12\x12\x12\x12\x00\x00\x00\x09\x00\x00\x00\x00"
        ...
        pytest.param(
            b"\x11\x22\x22\x11\x11\x11\x11\x11\x12\x12\x12\x12\x12\x12\x12\x12\x00\x00\xff\x09\x00\x00\x00\x00\x0a",
            ProtocolPayloadParserException(
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            b"\x88\x77\x66\x55\x44\x33\x22\x11\x21\x12\x22\x12\x22\x12\x22\x12\x42\x14\x00\x01\x00\x00\x00\x00\x0d"
    ...
    [
        ...
        pytest.param(
            ...
            (
                ...
                " (45 Bytes)      | 0x1122334455667788               | 0x1222122212221221               | 0x2442   | 0x00 | 0x01 | 0x00000000       | 0x0d |\n"
                "                 +----------------------------------+----------------------------------+----------+------+------+------------------+------+\n"
                "                 +----------------------------------+------+------+----------------------------------+------+------+\n"
    ...
    [
        pytest.param(
            PayloadFrame(
                ...
                payload=PayloadCommandMoveRaw(left_x=0, left_y=66, right_x=0, right_y=66),
            ),
        ...
        pytest.param(
            PayloadFrame(
                ...
                PayloadDotBotData(
                    ...
                    count=2,
                    locations=[
                        PayloadLh2RawLocation(bits=0x123456789ABCDEF1, polynomial_index=0x01, offset=0x02),
                        PayloadLh2RawLocation(bits=0x123456789ABCDEF1, polynomial_index=0x01, offset=0x02),
                    ],
                ),
            ),
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            PayloadFrame(
                Header(version=4, type_=2, destination=0x1122334455667788, source=0x1222122212221221),
                PayloadCommandMoveRaw(left_x=0, left_y=66, right_x=0, right_y=66),
            ),
            (
                "                 +------+------+----------------------------------+----------------------------------+------+------+------+------+------+\n"
        ...
        pytest.param(
            PayloadFrame(
                Header(version=4, type_=2, destination=0x1122334455667788, source=0x1222122212221221),
                PayloadGPSPosition(latitude=48856614, longitude=2352221),  # Paris coordinates
            ),
            (
                "                 +------+------+----------------------------------+----------------------------------+------+\n"
    ...
    class PayloadTest(Packet):
        ...
        metadata : list[PacketFieldMetadata] = dataclasses.field(
            default_factory=lambda: [
                PacketFieldMetadata(name="field", type_=int)
            ]
        )
        field: int = 0
...
def test_parse_non_registered_payload():
    with pytest.raises(ProtocolPayloadParserException) as excinfo:
        PayloadFrame().from_bytes(b"\x04\x02\x88\x77\x66\x55\x44\x33\x22\x11\x21\x12\x22\x12\x22\x12\x22\x12\xfd\x01")
