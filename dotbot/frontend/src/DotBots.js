...
import { ApplicationType, gps_distance_threshold, lh2_distance_threshold, maxWaypoints, NotificationType, maxPositionHistory, XGOActionId } from "./constants";
...
const XGOItem = (props) => {
  ...
  const applyAction = async (action) => {
    await apiUpdateXgoAction(props.dotbot.address, props.dotbot.application, action)
  }
  ...
  return (
    <div className="accordion-item">
      ...
      <div id={`collapse-${props.dotbot.address}`} className="accordion-collapse collapse" aria-labelledby={`heading-${props.dotbot.address}`} data-bs-parent="#accordion-xgo">
        <div className="accordion-body">
          <div className="d-flex mx-auto card">
            <div className="card-body p-1">
              <p className="m-0 p-0">
