...
export const SailBotMarker = (props) => {
  ...
  const wind_angle =  (props.sailbot.wind_angle / 16383.) * 359.978026 + 125;
  ...
  const svgIcon = L.divIcon({
    html: `
      ...
      >
      <g>
        <g transform="scale(1.5) rotate(${rotation+236} 11.8 11.8)">
        ...
        <g transform=" translate(-4.5,8) rotate(${rotation+236 - wind_angle+180} 22 10)">
