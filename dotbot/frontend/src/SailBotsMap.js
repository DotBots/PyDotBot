...
export const SailBotMarker = (props) => {
  ...
  const svgIcon = L.divIcon({
    html: `
      ...
      >
      <g transform="rotate(${rotation+56+180} 25 25)">
      ...
      <g transform="scale(1)">
        <g transform="rotate(${rotation+90 - wind_angle} 24.5 9.2)">
          <path fill="rgb(0, 0, 0)" d="M18.271,9.212H3.615l4.184-4.184c0.306-0.306,0.306-0.801,0-1.107c-0.306-0.306-0.801-0.306-1.107,0
