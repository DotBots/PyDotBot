...
export const SailBotMarker = (props) => {
  ...
  const svg_rotation_calibration = 57
  ...
  const svgIcon = L.divIcon({
    html: `
      ...
      >
      <g>
        <g transform="scale(1.5) rotate(${rotation+svg_rotation_calibration} 11.8 11.8)">
        ...
        <g transform=" translate(-4.5,8) rotate(${rotation+svg_rotation_calibration + wind_angle+34} 22 10)">
